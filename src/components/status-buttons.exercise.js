...
function StatusButtons({user, book}) {
  ...
  const [update] = useUpdateListItem(user, getMutationConfig())
  const [remove] = useRemoveListItem(user, getMutationConfig())
  const [create] = useCreateListItem(user, getMutationConfig())
